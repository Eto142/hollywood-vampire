...
*/
        ...
        var Dial = /** @class */ (function () {
          ...
          Dial.prototype.destroy = function () {
            ...
            if (this._initialized) {
              ...
              triggerEventTypes.hideEvents.forEach(function (ev) {
                _this._parentEl.removeEventListener(
                  ev,
                  _this._hideEventHandler
                );
              });
              this._initialized = false;
            }
      ...
      /***/ 340: /***/ function (
        ...
        var Drawer = /** @class */ (function () {
          ...
          Drawer.prototype.addEventListenerInstance = function (
            element,
            type,
            handler
          ) {
        ...
        function initDrawers() {
          ...
          document
            ...
            .forEach(function ($triggerEl) {
              ...
              var $drawerEl = document.getElementById(drawerId);
              if ($drawerEl) {
                var drawer_1 = instances_1.default.getInstance(
                  "Drawer",
                  drawerId
                );
                if (drawer_1) {
          ...
          document
            ...
            .forEach(function ($triggerEl) {
              ...
              var $drawerEl = document.getElementById(drawerId);
              if ($drawerEl) {
                var drawer_2 = instances_1.default.getInstance(
                  "Drawer",
                  drawerId
                );
                if (drawer_2) {
          ...
          document
            ...
            .forEach(function ($triggerEl) {
              ...
              var $drawerEl = document.getElementById(drawerId);
              if ($drawerEl) {
                var drawer_3 = instances_1.default.getInstance(
                  "Drawer",
                  drawerId
                );
                if (drawer_3) {
                  ...
                  drawer_3.addEventListenerInstance(
                    $triggerEl,
                    "click",
                    showDrawer
                  );
      ...
      /***/ 656: /***/ function (
        ...
        var InputCounter = /** @class */ (function () {
          ...
          InputCounter.prototype.removeInstance = function () {
            instances_1.default.removeInstance(
              "InputCounter",
              this._instanceId
            );
          };
      ...
      /***/ 16: /***/ function (
        ...
        var Modal = /** @class */ (function () {
          ...
          Modal.prototype.addEventListenerInstance = function (
            element,
            type,
            handler
          ) {
            ...
            .forEach(function ($triggerEl) {
              ...
              if ($modalEl) {
                ...
                if (modal_1) {
                  ...
                  modal_1.addEventListenerInstance(
                    $triggerEl,
                    "click",
                    toggleModal
                  );
            ...
            .forEach(function ($triggerEl) {
              ...
              if ($modalEl) {
                ...
                if (modal_2) {
                  ...
                  modal_2.addEventListenerInstance(
                    $triggerEl,
                    "click",
                    showModal
                  );
            ...
            .forEach(function ($triggerEl) {
              ...
              if ($modalEl) {
                ...
                if (modal_3) {
                  ...
                  modal_3.addEventListenerInstance(
                    $triggerEl,
                    "click",
                    hideModal
                  );
      ...
      /***/ 423: /***/ function (__unused_webpack_module, exports) {
        ...
        var Instances = /** @class */ (function () {
          ...
          Instances.prototype.addInstance = function (
            component,
            instance,
            id,
            override
          ...
          Instances.prototype.destroyAndRemoveInstance = function (
            component,
            id
          ) {
            if (!this._componentAndInstanceCheck(component, id)) {
          ...
          Instances.prototype._componentAndInstanceCheck = function (
            component,
            id
          ) {
            if (!this._instances[component]) {
