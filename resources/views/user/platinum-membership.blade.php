                    ...
                    <div class="">
                        <div class="flex lg:w-full mb-4">
                            <div class=" max-w-3xl lg:py-10 lg:px-20 mx-auto">
                                    ...
                                    <div class="flex items-center gap-x-6 rounded-xl py-6  px-10 bg-gradient-to-r from-[#683217] to-[#DCCDBE]">
                                        ...
                                        <div class="text-left text-white"><span class="text-xs">Membership Level</span>
                                            <h2 class="text-4xl font-semibold">Platinum</h2>
                                        </div>
                                    ...
                                    <div class="mt-3 items-center gap-x-6 rounded-xl py-6  px-10 border ">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="text-[0.9rem]"><span class="font-semibold">Regular</span> to <span class="font-semibold">Platinum</span></p>
                                        </div>

                                        <div class="mt-4">
                                            <h2 class="text-xs text-[#1d1b1aa0]">Due today:</h2>
                                            <p class="text-[0.9rem]">$80,000.00</p>
                                        </div>

                                    </div>

                                    <div class="mt-3">
                                        <form id="upgradeFormPlatinum" method="POST">
                                            @csrf
                                            <input type="hidden" name="new_membership" value="Platinum" />
                                    ...
                                    <script>
                                    document.getElementById('upgradeFormPlatinum').addEventListener('submit', function(e) {
                                        e.preventDefault();
