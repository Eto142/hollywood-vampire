                            ...
                            <div class=" max-w-3xl lg:py-10 lg:px-20 mx-auto">
                                    ...
                                    <div class="flex items-center gap-x-6 rounded-xl py-6  px-10 bg-gradient-to-r from-[#B0B0B0] to-[#DEDEDE]">
                                        ...
                                        <div class="text-left text-white"><span class="text-xs">Membership Level</span>
                                            <h2 class="text-4xl font-semibold">VIP</h2>
                                        </div>
                                    ...
                                    <div class="mt-3 items-center gap-x-6 rounded-xl py-6  px-10 border bg-white">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="text-[0.9rem]"><span class="font-semibold">Regular</span> to <span class="font-semibold">VIP</span></p>
                                        </div>

                                        <div class="mt-4">
                                            <h2 class="text-xs text-[#1d1b1aa0]">Due today:</h2>
                                            <p class="text-[0.9rem]">$25,000.00</p>
                                        </div>

                                    </div>

                                    <div class="mt-3">
                                        <form id="upgradeFormVIP" method="POST">
                                            @csrf
                                            <input type="hidden" name="new_membership" value="VIP" />
                                    ...
                                    <script>
                                    document.getElementById('upgradeFormVIP').addEventListener('submit', function(e) {
                                        e.preventDefault();
