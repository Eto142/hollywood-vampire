    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <div class="sidebar-brand">
            ...
            <div class="brand-text">
                <span class="brand-name">Hollywood Vampire</span>
            ...
            <div class="nav-section">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a href="{{route('admin.support.chats')}}" class="nav-link {{ request()->routeIs('admin.support.chats') ? 'active' : '' }}">
                            <i class="bi bi-chat-dots"></i>
                            <span class="nav-text">Manage Chats</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    ...
                    <li class="nav-item">
                        <a href="" class="nav-link ">
                            ...
                            <span class="nav-text">Pending Deposits</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.withdrawals.manage') }}" class="nav-link {{ request()->routeIs('withdrawals.manage') ? 'active' : '' }}">
             ...
             <div class="nav-section">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    ...
                    <li class="nav-item">
                        <a href="" class="nav-link ">
                            <i class="bi bi-credit-card-2-front-fill"></i>
                            <span class="nav-text">Ongoing Investments</span>
                        </a>
                    </li>
